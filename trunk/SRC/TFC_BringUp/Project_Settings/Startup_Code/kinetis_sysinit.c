...
static __declspec(vectortable) tVectorTable __vect_table = { /* Interrupt vector table */
   __SP_INIT,                                              /* 0 (0x00000000) (prior: -) */
  {
   ...
   (tIsrFunc)TFC_SysTickIrq,                               /* 15 (0x0000003C) (prior: -) */
   (tIsrFunc)DMA_CH0_IRQ,                                  /* 16 (0x00000040) (prior: -) */
   ...
   (tIsrFunc)UART3_ISR,                             		  /* 67 (0x0000010C) (prior: -) */
   (tIsrFunc)UNASSIGNED_ISR,                               /* 68 (0x00000110) (prior: -) */
   (tIsrFunc)UART4_ISR,                            		   /* 69 (0x00000114) (prior: -) */
   ...
   (tIsrFunc)PIT0_IRQ,                                   	/* 84 (0x00000150) (prior: -) */
   ...
   (tIsrFunc)PortB_IRQ,                               /* 104 (0x000001A0) (prior: -) */
